  ...
  openGraph={{
    ...
    images: [
      ...
      },
      {
        ...
        alt: "Business-led data and AI alignment with Data Governance, AI Governance, DataOps, MLOps, LLMOps, and AIOps",
      },
      {
        url: "https://" + String(curUrl) + "/images/data-ai-strategy.svg",
        alt: "Data and AI operating model with Data Governance, AI Governance, and XOps execution layers"
      },
      {
